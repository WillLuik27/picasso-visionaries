...
public class SemanticAnalyzer implements SemanticAnalyzerInterface {
	...
	private SemanticAnalyzer() {
		...
		//Path mapping
		tokenName = TOKENS_PACKAGE_NAME + "PathToken";
		parserName = PARSER_PACKAGE + "PathAnalyzer";
		addSemanticAnalyzerMapping(tokenName, parserName);
		


	    //Add a mapping for EqualsToken -> EqualsAnalyzer
	    tokenName = TOKENS_PACKAGE_NAME + "chars.EqualsToken";
	    parserName = PARSER_PACKAGE + "EqualsAnalyzer";
	    addSemanticAnalyzerMapping(tokenName, parserName);

	  //Add a mapping for CommaToken -> CommaAnalyzer
	    tokenName = TOKENS_PACKAGE_NAME + "chars.CommaToken";
	    parserName = PARSER_PACKAGE + "CommaAnalyzer";
	    addSemanticAnalyzerMapping(tokenName, parserName);
	    
	    // Add mapping for NotToken -> NotAnalyzer
	    tokenName = TOKENS_PACKAGE_NAME + "operations.NotToken";
	    parserName = PARSER_PACKAGE + "NotAnalyzer";
	    addSemanticAnalyzerMapping(tokenName, parserName);
	    
		/*
		 * //Add a mapping for ImageWrapToken -> ImageWrapAnalyzer tokenName =
		 * TOKENS_PACKAGE_NAME + "ImageWrapToken"; parserName = PARSER_PACKAGE +
		 * "ImageWrapAnalyzer"; addSemanticAnalyzerMapping(tokenName, parserName);
		 */
